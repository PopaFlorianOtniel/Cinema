    ...
    <div class="column-responsive column-80">
        <div class="movies view content">
            ...
            <table>
                <tr>
                    <th><?= __('Cinema') ?></th>
                    <td><?= $movie->has('cinema') ? $this->Html->link($movie->cinema->name, ['controller' => 'Cinemas', 'action' => 'view', $movie->cinema->id]) : '' ?></td>
                </tr>
                <tr>
                    <th><?= __('Title') ?></th>
                    <td><?= h($movie->title) ?></td>
            ...
            <div class="text">
                ...
                <blockquote>
                    <?= $this->Text->truncate($movie->description, 500); ?>
                </blockquote>
            </div>
            <div class="text">
                <strong><?= __('Image') ?></strong>
                <blockquote>
                    <?= $this->Text->autoParagraph($movie->image); ?>
                </blockquote>
            </div>
            <div class="related">
