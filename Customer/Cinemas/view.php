...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Html->link(__('Edit Cinema'), ['action' => 'edit', $cinema->slug], ['class' => 'side-nav-item']) ?>
            <?= $this->Form->postLink(__('Delete Cinema'), ['action' => 'delete', $cinema->slug], ['confirm' => __('Are you sure you want to delete # {0}?', $cinema->slug), 'class' => 'side-nav-item']) ?>
    ...
    <div class="column-responsive column-80">
        <div class="cinemas view content">
            ...
            <div class="text">
                ...
                <blockquote>
                    <?= $this->Text->autoParagraph(h($cinema->slug)); ?>
                </blockquote>
            </div>
            <div class="text">
            ...
            <div class="related">
                ...
                <div class="table-responsive">
                    <table>
                        ...
                        <?php foreach ($cinema->movies as $movies) : ?>
                        <tr>
                            <td><?= h($movies->id) ?></td>
                            <td><?= h($movies->user_id) ?></td>
                            <td><?= h($movies->cinema_id) ?></td>
