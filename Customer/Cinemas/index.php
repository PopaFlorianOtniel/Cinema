        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions">
                        <?= $this->Html->link(__('View'), ['action' => 'view', $cinema->slug]) ?>
                        <?= $this->Html->link(__('Edit'), ['action' => 'edit', $cinema->slug]) ?>
                        <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $cinema->slug], ['confirm' => __('Are you sure you want to delete # {0}?', $cinema->slug)]) ?>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
